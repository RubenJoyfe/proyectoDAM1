...
<head>
	...
	<meta charset="utf-8">
		<link rel="stylesheet" type="text/css" href="<?php echo $path; ?>css/Clicker.css">
		<script type="text/javascript" src="<?php echo $path; ?>js/Clicker.js"></script>
</head>
<body>
	<div class="juego">
		<h1>
		...
		<img src="<?php echo $path; ?>img/por-tutatis.png">
		<br>
